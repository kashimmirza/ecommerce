  ...
  <div className="t4s-top-bar" id="t4s-top-bar-main">
   <div className="t4s-container">
    <div className="t4s-row t4s-top-bar__wrap t4s-align-items-center">
     {/* First Part - Custom HTML with SVG */}
     <div
      id="b_top-bar-0"
      className="t4s-top-bar__html t4s-col-item t4s-col-12 t4s-text-center t4s-col-lg-9 t4s-text-lg-start t4s-d-none t4s-d-md-none t4s-d-lg-block"
     >
     ...
     {/* Second Part - Contact Info and Currency Dropdown */}
     <div className="t4s-top-bar__contact-info">
      <a
       className="t4s-ct"
      ...
      <div
       id="b_top-bar-2"
       className="t4s-top-bar__cur t4s-col-item t4s-col-12 t4s-text-center t4s-col-lg-3 t4s-text-lg-end"
      >
       <div className="t4s-top-bar__currencies t4s-d-inline-block">
        ...
        >
         ...
         <div className="t4s-dropdown__list">
          ...
          {/* Additional currency options can go here */}
         </div>
        </div>
       </div>
      </div>
