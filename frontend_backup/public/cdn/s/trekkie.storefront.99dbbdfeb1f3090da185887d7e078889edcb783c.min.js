! function() {
    var e = {
            ...
            1148: function(e, t, n) {
                ...
                function d(e, t) {
                    return "object" == typeof e && e.headlessStorefront && !e.storefrontAccessToken ? (console.warn("Headless consent has been updated. Please read shopify.dev/docs/api/customer-privacy to integrate."), r.setStorefrontApiTrackingConsent(e, t || (() => {}))) : o.setTrackingConsent(e, t)
                }
                t.analyticsProcessingAllowed = function() {
                    return o.haveAnalyticsConsent()
                }, t.currentVisitorConsent = u, t.marketingAllowed = s, t.preferencesProcessingAllowed = function() {
                    return o.havePreferencesConsent()
                }, t.saleOfDataAllowed = c, t.setTrackingConsent = d, t.shopifyConsentAPI = function(e = {
            ...
            5730: function(e, t, n) {
                ...
                function s(e) {
                    return e ? c() ? window.location.pathname + window.location.search : "/" : null
                }
                ...
                function p() {
                    return !1 === d() ? o.DisplayConsentValues.DECLINED : (e = r.getCCPAConsentValue(), r.validCookieDoesNotExist() ? o.DisplayConsentValues.NO_VALUE : e === o.ConsentValues.NO_VALUE ? o.DisplayConsentValues.NO_INTERACTION : r.transformConsentToDisplaySchema(e));
                    var e
                }
                t.saleOfDataRegion = r.saleOfDataRegion, t.GPCSignal = d, t.doesMerchantSupportGranularConsent = function() {
                    return !0
                ...
                }, t.getTrackingConsent = a, t.getTrackingConsentMetafield = function(e) {
                    return r.getCustomValue(e)
                }, t.getTrackingConsentMetafields = function() {
                    return r.getCustomValues()
                }, t.hasConsentForGDPR = u, t.haveAnalyticsConsent = function() {
                ...
                }, t.isBuyerOnFirstPageOfVisit = c, t.isRegulationEnforced = function() {
                    ...
                    return console.warn("shouldShowCCPABanner is deprecated and will be removed."), r.saleOfDataRegion() && p() === o.DisplayConsentValues.NO_INTERACTION
                }, t.shouldShowGDPRBanner = function() {
                    return r.shouldShowBanner() && a() === o.DisplayConsentValues.NO_INTERACTION
                }, t.userCanBeTracked = function() {
                    return !!r.validCookieDoesNotExist() || u()
                }, t.userDataCanBeSold = function() {
                    return console.warn("userDataCanBeSold is deprecated and will be replaced with saleOfDataAllowed."), r.saleOfDataAllowed()
                }
            },
            809: function(e, t) {
                "use strict";
                ...
                function n(e, t = !1) {
                    ...
                    if (t && "_tracking_consent" === e && !window.localStorage.getItem("tracking_consent_fetched")) return console.debug("_tracking_consent missing"), o(), window.localStorage.setItem("tracking_consent_fetched", "true"), n(e, !1)
                }
                ...
                Object.defineProperty(t, "__esModule", {
                    ...
                    let i = `${e}=${o}`;
                    i += "; path=/", t && (i += `; domain=${t}`), i += `; expires=${new Date((new Date).getTime()+n).toUTCString()}`, document.cookie = i
                }
            },
            9401: function(e, t, n) {
                "use strict";
            ...
            8680: function(e, t, n) {
                ...
                t.storefrontApiUpdateTrackingConsent = function(e, t) {
                    const n = e.granular_consent,
                        ...
                        p = n.isExtensionToken ? "Shopify-Storefront-Extension-Token" : "x-shopify-storefront-access-token",
                        l = {
                            headers: {
                    ...
                    return fetch(`https://${d}/api/unstable/graphql.json`, l).then((e => {
                        ...
                        return r.writeCookie(i.CONSENT_COOKIE_NAME, l, u, _), h && g && (r.writeCookie(s, l, d, h), r.writeCookie(c, l, d, g)), f !== l && (r.writeCookie(i.CONSENT_COOKIE_NAME, f, u, _), h && g && (r.writeCookie(s, f, d, h), r.writeCookie(c, f, d, g))), o.dispatchEvents(e), void 0 !== t && t(null, a), a
                    })).catch((e => {
                ...
                var v = function(e) {
                    ...
                    return r(n, e), n.prototype.name = function() {
                        ...
                        return i(i({
                            ...
                            asset_version_id: "99dbbdfeb1f3090da185887d7e078889edcb783c",
            ...
            1037: function(e, t, n) {
                ...
                t.metricsSchemaId = "trekkie_metrics/2.0", t.errorsSchemaId = "trekkie_errors/2.0", t.setGlobalSerializedAppConfig = function(e) {
                    ...
                    if (this.shouldSendToBugsnag()) {
                        var n = "99dbbdfeb1f3090da185887d7e078889edcb783c",
                            o = null,
                            r = null,
                            i = null;
                        if (e.appConfig) try {
                    ...
                    y = function() {
                        ...
                        return e.prototype.configureMonorailRegion = function(e) {
                            ...
                            a.addBatchEvent({
                                ...
                                payload: {
                                    build_id: "99dbbdfeb1f3090da185887d7e078889edcb783c",
