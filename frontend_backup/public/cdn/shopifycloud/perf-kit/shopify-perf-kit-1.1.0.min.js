! function() {
    ...
    function K(e) {
        ...
        e.OnInteraction = "perf_kit_on_interaction/3.0", e.OnUnload = "perf_kit_on_unload/3.2"
    }(U || (U = {}));
    ...
    function re() {
        if (null !== Y) {
            if (ae() && ne.size > 0) {
                ...
                const t = function(e) {
                    if (!(100 * Math.random() > (e || j))) return performance.getEntriesByType("resource").map((e => {
                ...
                t = t || {}, _((function() {
                    ...
                    var r, o = u("INP"),
                        i = function(e) {
                            ...
                            var t, n = (t = Math.min(N.length - 1, Math.floor(B() / 50)), N[t]);
                    ...
                    r = f(e, o, P, t.reportAllChanges), a && ("PerformanceEventTiming" in window && "interactionId" in PerformanceEventTiming.prototype && a.observe({
                        ...
                        i(a.takeRecords()), o.value < 0 && B() > 0 && (o.value = 0, o.entries = []), r(!0)
                    })), s((function() {
                        N = [], R = L(), o = u("INP"), r = f(e, o, P, t.reportAllChanges)
                    })))
                }))
            }((function(t) {
                ! function(e) {
        ...
        function() {
            ...
            try {
                t = function(e) {
                    ...
                    if (e.resourceTimingSamplingRate && (isNaN(Number(e.resourceTimingSamplingRate)) || Number(e.resourceTimingSamplingRate) < j || Number(e.resourceTimingSamplingRate) > 100)) throw new Error("Invalid resource timing sampling rate");
                    return {
                        storefrontData: {
