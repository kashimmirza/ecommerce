...
T4stt_var = {
    ...
    function(t, e) {
        ...
        function E(t, e, i) {
            i ? (Lt.set(t, e, !1), pt.event.add(t, e, {
                namespace: !1,
                handler: function(t) {
                    var n, o, s = Lt.get(this, e);
                    if (1 & t.isTrigger && this[e]) {
                        if (s.length)(pt.event.special[e] || {}).delegateType && t.stopPropagation();
                        else if (s = Z.call(arguments), Lt.set(this, e, s), n = i(this, e), this[e](), s !== (o = Lt.get(this, e)) || n ? Lt.set(this, e, !1) : o = {}, s !== o) return t.stopImmediatePropagation(), t.preventDefault(), o && o.value
                    } else s.length && (Lt.set(this, e, {
        ...
        function P(t, e) {
            ...
            if (1 === e.nodeType) {
                ...
                At.hasData(t) && (s = At.access(t), r = pt.extend({}, s), At.set(e, r))
            }
        }
        ...
        function D(t, e, n, o) {
            ...
            if (d && (r = (s = x(e, t[0].ownerDocument, !1, t, o)).firstChild, 1 === s.childNodes.length && (s = r), r || o)) {
                ...
                if (l)
                    for (u = a[a.length - 1].ownerDocument, pt.map(a, I), h = 0; h < l; h++) c = a[h], Gt.test(c.type || "") && !Lt.access(c, "globalEval") && pt.contains(u, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? pt._evalUrl && !c.noModule && pt._evalUrl(c.src, {
        ...
        var gt = function(t) {
            ...
            var b, x, S, w, T, C, E, _, k, I, P, D, L, A, z, N, M, j, W, O = "sizzle" + 1 * new Date,
                q = t.document,
                $ = 0,
                H = 0,
                R = i(),
            ...
            for (b in x = e.support = {}, T = e.isXML = function(t) {
                    ...
                    return n != L && 9 === n.nodeType && n.documentElement && (A = (L = n).documentElement, z = !T(L), q != L && (i = L.defaultView) && i.top !== i && (i.addEventListener ? i.addEventListener("unload", Tt, !1) : i.attachEvent && i.attachEvent("onunload", Tt)), x.scope = o(function(t) {
                        return A.appendChild(t).appendChild(L.createElement("div")), void 0 !== t.querySelectorAll && !t.querySelectorAll(":scope fieldset div").length
                    }), x.attributes = o(function(t) {
                        return t.className = "i", !t.getAttribute("className")
                    }), x.getElementsByTagName = o(function(t) {
                        return t.appendChild(L.createComment("")), !t.getElementsByTagName("*").length
                    }), x.getElementsByClassName = mt.test(L.getElementsByClassName), x.getById = o(function(t) {
                        return A.appendChild(t).id = O, !L.getElementsByName || !L.getElementsByName(O).length
                    ...
                    }, M = [], N = [], (x.qsa = mt.test(L.querySelectorAll)) && (o(function(t) {
                        var e;
                        A.appendChild(t).innerHTML = "<a id='" + O + "'></a><select id='" + O + "-\r\\' msallowcapture=''><option selected=''></option></select>", t.querySelectorAll("[msallowcapture^='']").length && N.push("[*^$]=" + et + "*(?:''|\"\")"), t.querySelectorAll("[selected]").length || N.push("\\[" + et + "*(?:value|" + tt + ")"), t.querySelectorAll("[id~=" + O + "-]").length || N.push("~="), (e = L.createElement("input")).setAttribute("name", ""), t.appendChild(e), t.querySelectorAll("[name='']").length || N.push("\\[" + et + "*name" + et + "*=" + et + "*(?:''|\"\")"), t.querySelectorAll(":checked").length || N.push(":checked"), t.querySelectorAll("a#" + O + "+*").length || N.push(".#.+[+~]"), t.querySelectorAll("\\\f"), N.push("[\\r\\n\\f]")
                    }), o(function(t) {
                        t.innerHTML = "<a href='' disabled='disabled'></a><select disabled='disabled'><option/></select>";
                        var e = L.createElement("input");
                        e.setAttribute("type", "hidden"), t.appendChild(e).setAttribute("name", "D"), t.querySelectorAll("[name=d]").length && N.push("name" + et + "*[*^$|!~]?="), 2 !== t.querySelectorAll(":enabled").length && N.push(":enabled", ":disabled"), A.appendChild(t).disabled = !0, 2 !== t.querySelectorAll(":disabled").length && N.push(":enabled", ":disabled"), t.querySelectorAll("*,:x"), N.push(",.*:")
                    })), (x.matchesSelector = mt.test(j = A.matches || A.webkitMatchesSelector || A.mozMatchesSelector || A.oMatchesSelector || A.msMatchesSelector)) && o(function(t) {
                        x.disconnectedMatch = j.call(t, "*"), j.call(t, "[s!='']:x"), M.push("!=", ot)
                    }), N = N.length && new RegExp(N.join("|")), M = M.length && new RegExp(M.join("|")), e = mt.test(A.compareDocumentPosition), W = e || mt.test(A.contains) ? function(t, e) {
                        ...
                        return i || (1 & (i = (t.ownerDocument || t) == (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1) || !x.sortDetached && e.compareDocumentPosition(t) === i ? t == L || t.ownerDocument == q && W(q, t) ? -1 : e == L || e.ownerDocument == q && W(q, e) ? 1 : I ? Z(I, t) - Z(I, e) : 0 : 4 & i ? -1 : 1)
                    } : function(t, e) {
                        if (t === e) return P = !0, 0;
                        var i, n = 0,
                            o = t.parentNode,
                            ...
                            a = [t],
                            l = [e];
                        if (!o || !s) return t == L ? -1 : e == L ? 1 : o ? -1 : s ? 1 : I ? Z(I, t) - Z(I, e) : 0;
                        if (o === s) return r(t, e);
                ...
                if (!d) {
                    ...
                    (d = F(t, (s = h, a = 0 < (r = u).length, l = 0 < s.length, c = function(t, i, n, o, c) {
                        var u, h, d, f = 0,
                            ...
                            w = b.length;
                        for (c && (k = i == L || i || c); p !== w && null != (u = b[p]); p++) {
                            if (l && u) {
                                for (h = 0, i || u.ownerDocument == L || (D(u), n = !z); d = s[h++];)
                                    if (d(u, i || L, n)) {
                                        o.push(u);
                                        break
                                    }
        ...
        pt.extend({
            ...
            data: function(t, e) {
                var i, n, o, s = this[0],
                    r = s && s.attributes;
                if (void 0 === t) {
                    if (this.length && (o = At.get(s), 1 === s.nodeType && !Lt.get(s, "hasDataAttrs"))) {
                ...
                return "object" == typeof t ? this.each(function() {
                    ...
                    var i;
                    if (s && void 0 === e) return void 0 !== (i = At.get(s, t)) ? i : void 0 !== (i = g(s, t)) ? i : void 0;
                    this.each(function() {
                        At.set(this, t, e)
                    })
            ...
            queue: function(t, e, i) {
                var n;
                if (t) return e = (e || "fx") + "queue", n = Lt.get(t, e), i && (!n || Array.isArray(i) ? n = Lt.access(t, e, pt.makeArray(i)) : n.push(i)), n || []
            },
            ...
            promise: function(t, e) {
                ...
                for ("string" != typeof t && (e = t, t = void 0), t = t || "fx"; r--;)(i = Lt.get(s[r], t + "queueHooks")) && i.empty && (n++, i.empty.add(a));
        ...
        pt.event = {
            ...
            add: function(t, e, i, n, o) {
                var s, r, a, l, c, u, h, d, f, p, g, m = Lt.get(t);
                if (Dt(t))
            ...
            remove: function(t, e, i, n, o) {
                var s, r, a, l, c, u, h, d, f, p, g, m = Lt.hasData(t) && Lt.get(t);
                if (m && (l = m.events)) {
            ...
            special: {
                ...
                click: {
                    ...
                    _default: function(t) {
                        var e = t.target;
                        return Ut.test(e.type) && e.click && s(e, "input") && Lt.get(e, "click") || s(e, "a")
                    }
                },
                beforeunload: {
        ...
        pt.extend({
            ...
            css: function(t, e, i, n) {
                var o, s, r, a = f(e);
                return le.test(e) || (e = N(a)), (r = pt.cssHooks[e] || pt.cssHooks[a]) && "get" in r && (o = r.get(t, !0, i)), void 0 === o && (o = A(t, e, n)), "normal" === o && e in ue && (o = ue[e]), "" === i || i ? (s = parseFloat(o), !0 === i || isFinite(s) ? s || 0 : o) : o
            }
            ...
            if (e) return (parseFloat(A(t, "marginLeft")) || t.getBoundingClientRect().left - ie(t, {
                marginLeft: 0
            }, function() {
        ...
        pt.Animation = pt.extend(B, {
            ...
            prefilters: [function(t, e, i) {
                ...
                if ((l = !pt.isEmptyObject(e)) || !pt.isEmptyObject(f))
                    for (n in h && 1 === t.nodeType && (i.overflow = [p.overflow, p.overflowX, p.overflowY], null == (c = m && m.display) && (c = Lt.get(t, "display")), "none" === (u = pt.css(t, "display")) && (c ? u = c : (v([t], !0), c = t.style.display || c, u = pt.css(t, "display"), v([t]))), ("inline" === u || "inline-block" === u && null != c) && "none" === pt.css(t, "float") && (l || (d.done(function() {
                            p.display = c
                        ...
                        for (n in g || v([t]), Lt.remove(t, "fxshow"), f) pt.style(t, n, f[n])
        ...
        pt.fn.extend({
            ...
            toggleClass: function(t, e) {
                ...
                return "boolean" == typeof e && n ? e ? this.addClass(t) : this.removeClass(t) : ct(t) ? this.each(function(i) {
                    ...
                    else void 0 !== t && "boolean" !== i || ((e = U(this)) && Lt.set(this, "__className__", e), this.setAttribute && this.setAttribute("class", e || !1 === t ? "" : Lt.get(this, "__className__") || ""))
                })
            },
            hasClass: function(t) {
                var e, i, n = 0;
        ...
        pt.extend(pt.event, {
            trigger: function(e, i, n, o) {
                ...
                if (r = d = a = n = n || ht, 3 !== n.nodeType && 8 !== n.nodeType && !we.test(p + pt.event.triggered) && (-1 < p.indexOf(".") && (p = (g = p.split(".")).shift(), g.sort()), c = p.indexOf(":") < 0 && "on" + p, (e = e[pt.expando] ? e : new pt.Event(p, "object" == typeof e && e)).isTrigger = o ? 2 : 3, e.namespace = g.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), i = null == i ? [e] : pt.makeArray(i, [e]), h = pt.event.special[p] || {}, o || !h.trigger || !1 !== h.trigger.apply(n, i))) {
                    ...
                    for (s = 0;
                        (r = f[s++]) && !e.isPropagationStopped();) d = r, e.type = 1 < s ? l : h.bindType || p, (u = (Lt.get(r, "events") || Object.create(null))[e.type] && Lt.get(r, "handle")) && u.apply(r, i), (u = c && r[c]) && u.apply && Dt(r) && (e.result = u.apply(r, i), !1 === e.result && e.preventDefault());
        ...
        pt.ajaxSetup({
            ...
            pt.cssHooks[e] = z(lt.pixelPosition, function(t, i) {
                if (i) return i = A(t, e), te.test(i) ? pt(t).position()[e] + "px" : i
            })
        }), pt.each({
            Height: "height",
            Width: "width"
